                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                             ...
                             <li class="{{request()->is('book/all-book-list') ? 'active-item':'' }}"><a href="{{route('all-book-list')}}"><i class="fa fa-list" aria-hidden="true"></i>Book List</a></li>


                               <li class="{{request()->is('book/my-issue-book-list') ? 'active-item':''}}"><a href="{{route('my-issue-book-list', Auth::user()->registration_no)}}"><i class="fa fa-book" aria-hidden="true"></i><span>My Issue Book List</span></a></li>
